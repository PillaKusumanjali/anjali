	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h2 style="color: white;margin-top: 13px;" id="myhead">Learning Portal for Deaf Students</h2>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="cta-div">
								...
								<a href="#myservice_section" class="btn2">LEARN MORE</a>
							</div>
							<br><br>
         	...
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the lecture tutorials related courses
         					like Alphabets , Numbers, Phonics etc
         				</p>
         			</div>
         		</div>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the videos tutorials related to Courses 
         			like Alphabets , Numbers, Phonics etc
         				</p>
         			</div>
         		</div>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find excercise which will improve your knowledge.
         				</p>
         			</div>
         		</div>
<!-- 
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
								E-LEARN is a learning platform for the deaf students who can increase their knowledge.	
											</p>
										</div>
									</div>
								</div>
...
<div class="row text-center">
	<h2><b>Discussion form</b></h2><br><br>
	<center>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Doubt</label>
